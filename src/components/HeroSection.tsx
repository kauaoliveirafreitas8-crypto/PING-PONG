    ...
    <section id="hero-section" className="relative overflow-hidden bg-[#FFFFFF]">
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 pt-3 sm:pt-4 lg:pt-5 pb-10 sm:pb-12 lg:pb-16">
        ...
        <div className="lg:hidden relative z-10 text-center mb-3 px-1 max-w-xl mx-auto">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#15803D]/10 text-[#15803D] font-bold text-[11px] uppercase tracking-wider mb-3.5 sm:mb-4">
            <span className="w-1.5 h-1.5 rounded-full bg-[#15803D] shrink-0" />
            MATERIAL ALINHADO A CBTM
          </span>
          <h1 className="font-black text-[#0A192F] tracking-tight leading-[1.15] text-2xl sm:text-3xl uppercase">
          ...
          <p className="mt-2 text-center text-slate-700 font-medium text-[14px] sm:text-[15px] leading-snug max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-6 lg:gap-10 items-center">
          ...
          <div className="relative z-10 order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <p className="mt-3.5 max-w-lg lg:max-w-xl mx-auto lg:mx-0 text-[14.5px] sm:text-[15.5px] leading-relaxed text-slate-500 text-center lg:text-left font-normal">
            ...
            <div className="mt-6 sm:mt-8 flex w-full justify-center lg:justify-start">
              ...
              >
                <span>QUERO TER ACESSO ÀS FICHAS</span>
                <ArrowRight className="w-5 h-5 shrink-0" strokeWidth={2.8} />
              </a>
            </div>

            {/* Delivery & Access Badge */}
            <div className="mt-5 lg:mt-6 w-full max-w-lg lg:max-w-xl rounded-xl bg-[#F0F7FF] border border-[#BFDBFE] px-4 py-2.5 sm:px-5 sm:py-3 shadow-sm text-center lg:text-left">
              <p className="text-[#0A192F] font-bold text-[13px] sm:text-[14px] leading-relaxed m-0 text-center lg:text-left uppercase">
                RECEBA SEU MATERIAL IMEDIATAMENTE APÓS A CONFIRMAÇÃO DO PAGAMENTO E ACESSE PELO{" "}
                <span className="whitespace-nowrap font-black">📱 CELULAR</span>,{" "}
                <span className="whitespace-nowrap font-black">📲 TABLET</span> OU{" "}
                <span className="whitespace-nowrap font-black">🖥️ COMPUTADOR</span>.
              </p>
            </div>
          </div>
          ...
          <div className="relative w-full order-1 lg:order-2 flex items-center justify-center my-2 sm:my-4 lg:my-0">
            <div className="relative w-full max-w-[340px] sm:max-w-[440px] md:max-w-[480px] lg:max-w-none flex items-center justify-center">
              <div className="relative w-full rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,102,204,0.18)] border border-slate-200 bg-white">
                <img
