    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#0066CC]/10 text-[#0066CC] font-black text-[11px] sm:text-xs uppercase tracking-wider mb-2.5 sm:mb-3 shadow-xs">
            <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0066CC]" />
            ACESSO 100% DIGITAL & IMEDIATO
          </span>
          <h2 className="font-black text-xl sm:text-3xl md:text-4xl text-[#0A192F] uppercase tracking-tight">
            COMO VOU RECEBER O MATERIAL?
          </h2>
          <p className="mt-1.5 sm:mt-2 text-slate-600 font-medium text-xs sm:text-base max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 relative">
          ...
          <div className="relative rounded-2xl sm:rounded-3xl bg-white border-2 border-blue-200/80 p-5 sm:p-7 shadow-[0_8px_20px_rgba(0,102,204,0.06)] flex flex-col items-center text-center hover:border-[#0066CC] hover:-translate-y-1 transition-all duration-300">
            <span className="absolute -top-3 px-3 py-0.5 rounded-full bg-[#0066CC] text-white font-black text-[10.5px] uppercase tracking-wider shadow-xs">
              PASSO 01
            </span>
            ...
            <h3 className="font-black text-sm sm:text-lg text-[#0A192F] uppercase tracking-tight">
              Chega no seu e-mail
            </h3>
            <p className="mt-1.5 sm:mt-2 text-slate-600 text-xs sm:text-sm leading-relaxed">
