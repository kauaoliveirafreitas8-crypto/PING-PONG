  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-1.5 sm:mt-2 text-center text-slate-600 font-bold text-[11px] sm:text-sm uppercase">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full py-3.5 sm:py-4 text-left font-semibold text-[#0A192F] hover:no-underline flex items-center justify-between gap-3 sm:gap-4 cursor-pointer"
                  aria-expanded={isOpen}
                >
                  <span className="text-xs sm:text-base md:text-lg leading-snug">{item.q}</span>
                  <ChevronDown
                ...
                {isOpen && (
                  <div className="pb-4 pt-1 text-slate-600 leading-relaxed text-xs sm:text-sm md:text-base whitespace-pre-line border-t border-slate-200/60 mt-1">
                    {item.a}
                  </div>
                )}
              </div>
